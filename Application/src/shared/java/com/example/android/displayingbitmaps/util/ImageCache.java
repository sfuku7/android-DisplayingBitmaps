...
public class ImageCache {
    ...
    private AbstractBitmapFactory mBitmapFactory;
    /**
    ...
    private ImageCache(ImageCacheParams cacheParams,
        ...
        init(cacheParams, bitmapFactory, memoryImageCacheFactory);
    }
    ...
    public static ImageCache getInstance(
            ObjectHolderFactory objectHolderFactory,
            MemoryImageCacheFactory memoryImageCacheFactory,
            AbstractBitmapFactory bitmapFactory,
        ...
        if (imageCache == null) {
            imageCache = new ImageCache(cacheParams, bitmapFactory, memoryImageCacheFactory);
    ...
    private void init(ImageCacheParams cacheParams,
        ...
        if (mCacheParams.memoryCacheEnabled) {
            ...
            mMemoryCache = memoryImageCacheFactory.createMemoryImageCache(mCacheParams.memCacheSize);
        }
     ...
     */
    public void addBitmapToCache(String data, AbstractBitmapDrawable value) {
     ...
     */
    public AbstractBitmapDrawable getBitmapFromMemCache(String data) {
        //BEGIN_INCLUDE(get_bitmap_from_mem_cache)
        AbstractBitmapDrawable memValue = null;
     ...
     */
    public AbstractBitmap getBitmapFromDiskCache(String data) {
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        if (inputStream != null) {
                            ...
                            bitmap = mBitmapFactory.decodeSampledBitmapFromDescriptor(
    ...
    protected AbstractBitmap getBitmapFromReusableSet(Object optionsPlatformDepend) {
        ...
        return mMemoryCache.getBitmapFromReusableSet(optionsPlatformDepend);
